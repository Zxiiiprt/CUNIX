...
/**
 * Description : This is is a lot of the meat of the salad. At this point the user is logged in and is interacting with the shell dreictly
...
/**
 * Description : This is the engine that takes an operating and dissects it to find out what it should do, and then sends it to get done
 *@param: receiver = the memory context that we are dealing with
 *@param server_ID = the ID of the server that we are dealing with
 */
